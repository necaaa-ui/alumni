...
exports.handleScholarshipSSO = async (req, res) => {
  ...
  try {
    ...
    // Redirect to your React frontend Scholarship Dashboard
    return res.redirect(
      302,
      `https://necalumni.nec.edu.in/alumnimain/scholarship-dashboard?email=${encodeURIComponent(encodedEmail)}`
    );
  } catch (err) {
